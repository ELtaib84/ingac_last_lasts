           ...
           <div class="container">
               <div class="row">
                   <div class="col-12 col-lg-8 offset-lg-2 text-center position-relative z-index wow zoomIn" data-wow-duration="1.5s"> 
                           ...
                           <a href="/contact" class="btn fables-second-background-color white-color white-color-hover fables-btn-rounded  mt-4 py-2 px-5 position-relative z-index">تواصل معنا </a>  
                   </div> 
               </div>
                                         ...
                                         <div class="card rounded-0 border-light wow fadeIn mb-4 mb-lg-0" data-wow-delay=".8s">
                                           <div class="row">
                                              ...
                                              <div class="card-body col-12">
                                                ...
                                                <p class="card-text fables-fifth-text-color fables-store-product-details mx-3 store-card-text">بنجلاديش  </p>
                                         ...
                                         <div class="card rounded-0 border-light wow fadeIn mb-4 mb-lg-0" data-wow-delay="1.2s">
                                                   <div class="row">
                                                      ...
                                                      <div class="card-body col-12">
                                                        ...
                                                        <p class="card-text fables-fifth-text-color fables-store-product-details mx-3 store-card-text"> كينيا </p>
                                         ...
                                         <div class="card rounded-0 border-light wow fadeIn mb-4 mb-lg-0" data-wow-delay="1.6s">
                                                   <div class="row">
                                                      ...
                                                      <div class="card-body col-12">
                                                        ...
                                                        <p class="card-text fables-fifth-text-color fables-store-product-details mx-3 store-card-text"> اثيوبيا </p>
                                         ...
                                         <div class="card rounded-0 border-light wow fadeIn mb-4 mb-lg-0" data-wow-delay="1.6s">
                                                   <div class="row">
                                                      ...
                                                      <div class="card-body col-12">
                                                        ...
                                                        <p class="card-text fables-fifth-text-color fables-store-product-details mx-3 store-card-text"> اوغندا </p>
