...
<div class="container-fluid" dir="ltr" style="text-align: right">
    <div class="row mt-3 mt-md-5">
        <div class="col-12 col-lg-5 offset-lg-1 mb-4 mb-lg-0 overflow-hidden"> 
            <h2 class="fables-second-text-color font-35 bold-font wow fadeInLeft"> تواصل معنا  <span class="fables-main-text-color"> </span></h2>
            ...
            <p class="fables-forth-text-color my-3 wow fadeInLeft">+966 595 674 748 - +966 595 674 429</p>
            <p class="fables-forth-text-color my-3 wow fadeInLeft">+966 598 263 807 - +966 591 662 538</p>
            <p class="fables-forth-text-color my-3 wow fadeInLeft">+966 593 318 190 - +966 595 748 685</p> 
            <p class="fables-forth-text-color my-3 wow fadeInLeft">
              adminsupport@website.com : البربد الاكتروني
        ...
        <div class="col-12 col-lg-5 offset-lg-1 p-0 text-right mb-lg-5">  
             <div class="choose-img-border-after fables-second-border-color position-relative">
                  <img src="assets/custom/images/2.jpeg" alt="" class="w-100">  
             </div>
        </div>
 </div>
